...
/>
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="py-5 bg-primary">
        <div className="container-fluid px-5">
...
<section id="contact" className="bg-light py-5">
      <div className="container px-4">
        <h2 className="text-center fw-bold mb-4 animate__animated animate__fadeIn">Kirim Pesan</h2>
        <div className="row justify-content-center">
          <div className="col-md-8">
            <form
              action="https://formsubmit.co/rifalfebiyan123@gmail.com"
              method="POST"
              className="shadow-lg p-4 bg-white rounded animate__animated animate__fadeInUp"
            >
              <input type="hidden" name="_captcha" value="false" />
              <input type="hidden" name="_next" value="https://web-profile-ashy.vercel.app/?success=true" />
              ...
              <div className="mb-3 input-group">
                <span className="input-group-text bg-white align-start">
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content text-center p-4">
            <div className="modal-body">
              ...
              <h5 className="mb-2">Pesan Terkirim</h5>
              <p className="mb-0">Terima kasih telah menghubungi saya.</p>
            </div>
          </div>
        </div>
      </div>
